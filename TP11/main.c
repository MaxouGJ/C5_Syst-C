...
int execute_command(int argc, char** argv) {
    ...
    if (strcmp(argv[0], "status") == 0)
      return execute_command_status(argc, argv);
    if (strcmp(argv[0], "cd") == 0)
      return execute_command_cd(argc, argv);
    if (strcmp(argv[0], "pwd") == 0)
      return execute_command_pwd(argc, argv);
    if (strcmp(argv[0], "jobs") == 0)
      return execute_command_jobs(argc, argv);
    if(strcmp(argv[0], "<") == 0)
      return execute_command_redirect(argc, argv);
    if(strcmp(argv[0], ">") == 0)
      return execute_command_redirect(argc, argv);
    if(strcmp(argv[0], ">2") == 0)
      return execute_command_redirect(argc, argv);
    else
        return execute_command_external(argc, argv);
}
